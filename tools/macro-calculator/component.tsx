            ...
            <div className="space-y-5 rounded-3xl border border-emerald-200 bg-gradient-to-br from-white to-emerald-50 p-4 shadow-sm md:p-6">
              <div className="grid gap-4 rounded-3xl border border-sky-100 bg-white p-5 text-center text-slate-950 shadow-sm sm:grid-cols-2 sm:items-center">
                <div className="rounded-2xl bg-sky-50 p-4">
                  ...
                  <p className="mt-1 text-sm font-bold text-slate-500">{getText(toolUi.caloriesLabel, lang)}</p>
                </div>
              ...
              <div className="rounded-3xl border border-sky-100 bg-gradient-to-br from-sky-50 to-emerald-50 p-5 text-center text-slate-950 shadow-xl shadow-sky-100/70 md:p-6">
                ...
                <p className="mx-auto mt-4 max-w-2xl text-sm font-medium leading-6 text-slate-600 md:text-base">{getText(toolUi.ctaDescription, lang)}</p>
              </div>
