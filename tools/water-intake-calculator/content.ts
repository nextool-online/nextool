export const waterIntakeCalculatorContent = {
  ...
  description: {
    en: "Estimate your recommended daily water intake based on body weight and activity level.",
  },
  ...
  ui: {
    ...
    helper: {
      en: "Estimate your daily water intake.",
    },
    ...
    activityMinutes: {
      en: "Activity Minutes Per Day",
    },

    waterMl: {
      en: "Daily Water Intake (ml)",
    },

    waterLiters: {
      en: "Daily Water Intake (liters)",
    },
  },
};