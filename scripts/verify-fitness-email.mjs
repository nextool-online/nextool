...
assert.match(ptHtml.html, /Guarde este email para comparar depois/);
assert.match(ptHtml.html, /border-radius:18px/);
assert.match(ptHtml.html, /background:#f0f9ff/);
assert.match(ptHtml.html, /body bgcolor="#f0f9ff"/);
assert.match(ptHtml.html, /color:#111827 !important/);
assert.match(ptHtml.html, /#bae6fd/);
assert.match(ptHtml.html, /border-left:6px solid/);
assert.match(ptHtml.html, /#fffbeb/);
...
assert.match(enHtml.html, /bgcolor="#34d399"/);
assert.match(enHtml.html, /color:#0f172a !important/);
assert.match(enHtml.html, /\/api\/fitness\/email-click/);
assert.match(enHtml.html, /tid=email01metrics/);
...
const emailClickRouteSource = fs.readFileSync(new URL("../app/api/fitness/email-click/route.ts", import.meta.url), "utf8");
