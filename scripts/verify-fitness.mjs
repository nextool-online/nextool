...
assert.match(fitnessJourneySource, /visualVariant === "soft-health"/);
assert.match(fitnessJourneySource, /from-sky-50/);
assert.match(toolPageLayoutSource, /fitness-soft-health/);
assert.match(toolPageSource, /searchParams/);
assert.match(toolPageSource, /soft-health/);
assert.match(fitnessPageSource, /searchParams/);
assert.match(fitnessPageSource, /soft-health/);
assert.match(proteinCalculatorSource, /visualVariant === "soft-health"/);
assert.match(proteinCalculatorSource, /bg-sky-50/);
assert.match(proteinCalculatorSource, /soft-health/);
