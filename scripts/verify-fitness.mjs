...
const fitnessDashboardSource = fs.readFileSync(new URL("../app/[lang]/fitness/dashboard/page.tsx", import.meta.url), "utf8");
...
assert.match(mediterraneanPageSource, /qualified professional/);
assert.match(mediterraneanPageSource, /Get your Mediterranean Diet Plan/);
...
assert.match(fitnessDashboardSource, /Paid landing funnel/);
assert.match(fitnessDashboardSource, /paid-landing-funnel/);
assert.match(fitnessDashboardSource, /buildPaidLandingMetrics/);
assert.match(fitnessDashboardSource, /utm_source=google/);
assert.match(fitnessDashboardSource, /calorie-deficit-calculator/);
