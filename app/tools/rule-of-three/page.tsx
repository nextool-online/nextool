...
export default function RuleOfThreePage() {
  ...
  return (
    ...
    >
         <div className="rounded-2xl border border-zinc-200 bg-white p-4 shadow-sm md:p-8">
          <div className="mb-5">
        ...
        <article className="mt-10 space-y-5 text-base leading-7 text-zinc-700 md:mt-12 md:space-y-6 md:leading-8">
          ...
          <p>
            If A corresponds to B and C corresponds to X, then X is calculated
            by multiplying B by C and dividing the result by A.
          </p>
        </article>
      </ToolPageLayout>
  );
