...
export function FitnessEmailSentPage({ lang }: { lang: LanguageCode }) {
  return (
    <main className="min-h-screen bg-zinc-950 px-4 py-10 text-white">
      <section className="mx-auto max-w-3xl rounded-[2rem] border border-emerald-400/20 bg-white p-5 text-zinc-950 shadow-2xl shadow-emerald-950/20 md:p-8">
        <div className="rounded-[1.7rem] border border-emerald-200 bg-emerald-50 p-5 md:p-7">
        ...
        <div className="mt-5 rounded-[1.7rem] border border-zinc-200 bg-zinc-950 p-5 text-white md:p-7">
          ...
          <Link
            ...
            className="mt-5 inline-flex rounded-full bg-emerald-400 px-6 py-3 text-sm font-black text-zinc-950 transition hover:bg-emerald-300"
          >
