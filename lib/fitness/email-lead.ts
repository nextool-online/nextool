...
export function buildFitnessEmailHtml(payload: FitnessLeadPayload) {
  ...
  const offerUrl = "https://www.nextool.online/en/fitness/next-steps/mediterranean-meal-plan?utm_source=email&utm_medium=metrics_email&utm_campaign=mediterranean_meal_plan&utm_content=email_01_metrics_offer";
  const offerBlock = isPt
    ? ""
    : `<div style="margin:22px 0 0;border:1px solid #a7f3d0;border-radius:26px;background:linear-gradient(135deg,#ecfdf5,#e0f2fe);padding:20px 18px;box-shadow:0 14px 36px rgba(16,185,129,.10);"><p style="margin:0 0 8px;color:#047857;font-size:12px;font-weight:900;letter-spacing:.14em;text-transform:uppercase;">Optional accelerator</p><h2 style="margin:0 0 10px;color:#0f172a;font-size:24px;line-height:1.15;font-weight:900;">Based on your numbers and your goals</h2><p style="margin:0 0 16px;color:#334155;font-size:15px;line-height:1.65;font-weight:700;">With the right support, your calorie target can become a meal routine faster than trying to figure it out alone. See a Mediterranean-style path designed to make the next step easier.</p><p style="margin:0;text-align:center;"><a href="${offerUrl}" style="display:block;background:#34d399;color:#0f172a;text-decoration:none;border-radius:999px;padding:15px 20px;font-weight:900;font-size:15px;text-transform:uppercase;letter-spacing:.03em;">Get your Mediterranean Diet Plan</a></p></div>`;
